...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((option) =>
      option
        ...
        .addRoleOption((option) =>
          option
            .setName("role")
            .setDescription("Role to mention when sending the log")
        )
    ...
    .addSubcommand((option) =>
      option
        .setName("status")
        .setDescription("Get stats for the logging system")
    )
    .addSubcommand((option) =>
      ...
      case "setup":
        {
          ...
          if (
            !Object.getOwnPropertyNames(loggerSchema.toObject()).includes(
              category
            )
          ) {
            if (!channelId) {
