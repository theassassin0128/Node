...
export type ModalActionRowComponentData =
  | JSONEncodable<APIModalActionRowComponent>
  | TextInputComponentData;

export type ActionRowComponentData =
...
export class ActionRow<
  ComponentType extends MessageActionRowComponent | ModalActionRowComponent
> extends Component<
  APIActionRowComponent<
    APIMessageActionRowComponent | APIModalActionRowComponent
  >
...
export class AutoModerationRule extends Base {
  ...
  public setExemptChannels(
    channels:
      | ReadonlyCollection<Snowflake, GuildBasedChannel>
...
export type ApplicationFlagsResolvable = BitFieldResolvable<
...
export type BooleanCache<Cached extends CacheType> = Cached extends "cached"
  ? true
  : false;

export abstract class CommandInteraction<
  Cached extends CacheType = CacheType
> extends BaseInteraction<Cached> {
...
> extends MessageComponentInteraction<Cached> {
  private constructor(
    client: Client<true>,
    data: RawMessageButtonInteractionData
  );
...
export class UserSelectMenuBuilder extends BuilderUserSelectMenuComponent {
  ...
  public static from(
    other: JSONEncodable<APIUserSelectComponent> | APIUserSelectComponent
...
export class RoleSelectMenuBuilder extends BuilderRoleSelectMenuComponent {
  ...
  public static from(
    other: JSONEncodable<APIRoleSelectComponent> | APIRoleSelectComponent
...
export class MentionableSelectMenuBuilder extends BuilderMentionableSelectMenuComponent {
  ...
  public static from(
    other:
      | JSONEncodable<APIMentionableSelectComponent>
      | APIMentionableSelectComponent
...
export class StringSelectMenuOptionBuilder extends BuildersSelectMenuOption {
  public constructor(
    data?: SelectMenuComponentOptionData | APISelectMenuOption
  );
  public override setEmoji(emoji: ComponentEmojiResolvable): this;
  public static from(
    other: JSONEncodable<APISelectMenuOption> | APISelectMenuOption
...
export class TextInputBuilder extends BuilderTextInputComponent {
  ...
  public static from(
    other: JSONEncodable<APITextInputComponent> | APITextInputComponent
  ): TextInputBuilder;
}
...
export class BaseSelectMenuComponent<
  Data extends APISelectMenuComponent
> extends Component<Data> {
...
export interface EmbedAuthorData
  extends Omit<APIEmbedAuthor, "icon_url" | "proxy_icon_url">,
    IconData {}

export interface EmbedFooterData
  extends Omit<APIEmbedFooter, "icon_url" | "proxy_icon_url">,
    IconData {}
...
export class ChannelFlagsBitField extends BitField<ChannelFlagsString> {
  ...
  public static resolve(
    bit?: BitFieldResolvable<ChannelFlagsString, ChannelFlags>
  ): number;
}
...
export class Client<Ready extends boolean = boolean> extends BaseClient {
  ...
  >(
    ...
    Emitter extends Client ? ClientEvents[Event] : any[]
  >;
  ...
  public fetchStickerPacks(options: {
    packId: Snowflake;
  }): Promise<StickerPack>;
  public fetchStickerPacks(
    options?: StickerPackFetchOptions
  ): Promise<Collection<Snowflake, StickerPack>>;
...
export class ClientApplication extends Application {
  ...
  public edit(
    options: ClientApplicationEditOptions
...
> extends EventEmitter {
  ...
  public on<EventKey extends keyof CollectorEventTypes<Key, Value, Extras>>(
    event: EventKey,
    listener: (
      ...args: CollectorEventTypes<Key, Value, Extras>[EventKey]
    ) => void
  ): this;
...
> extends BaseInteraction<Cached> {
  ...
  public respond(
    options: readonly ApplicationCommandOptionChoiceData[]
  ): Promise<void>;
}
...
> {
  private constructor(
    application: ClientApplication,
    iterable?: Iterable<RawApplicationEmojiData>
  );
  public application: ClientApplication;
  public create(
  ...
  public fetch(
    id?: undefined,
    options?: BaseFetchOptions
  ): Promise<Collection<Snowflake, ApplicationEmoji>>;
...
export class Entitlement extends Base {
  ...
  public isUserSubscription(): this is this & {
    guildId: null;
    get guild(): null;
  };
  public isGuildSubscription(): this is this & {
    guildId: Snowflake;
    guild: Guild;
  };
}
...
export class Guild extends AnonymousGuild {
  ...
  public editWelcomeScreen(
    options: WelcomeScreenEditOptions
...
export class GuildMemberFlagsBitField extends BitField<GuildMemberFlagsString> {
  ...
  public static resolve(
    bit?: BitFieldResolvable<GuildMemberFlagsString, GuildMemberFlags>
  ): number;
}
...
export class GuildOnboardingPromptOption extends Base {
  private constructor(
    client: Client,
    data: APIGuildOnboardingPromptOption,
    guildId: Snowflake
  );
...
export class GuildScheduledEvent<
  Status extends GuildScheduledEventStatus = GuildScheduledEventStatus
> extends Base {
...
export class IntegrationApplication extends Application {
  private constructor(
    client: Client<true>,
    data: RawIntegrationApplicationData
  );
  public bot: User | null;
  public termsOfServiceURL: string | null;
  public privacyPolicyURL: string | null;
...
export class IntentsBitField extends BitField<GatewayIntentsString> {
  ...
  public static resolve(
    bit?: BitFieldResolvable<GatewayIntentsString, number>
  ): number;
}
...
export class InteractionCallback {
  private constructor(
    client: Client<true>,
    data: RESTAPIInteractionCallbackObject
  );
...
export class InteractionCallbackResponse {
  private constructor(
    client: Client<true>,
    data: RESTPostAPIInteractionCallbackWithResponseResult
  );
  public readonly client: Client<true>;
...
export class InteractionCallbackResource {
  private constructor(
    client: Client<true>,
    data: RESTAPIInteractionCallbackResourceObject
  );
...
> {
  ...
  public on(
    event: "end",
    listener: (
      collected: ReadonlyCollection<Snowflake, Interaction>,
      reason: string
    ) => void
  ): this;
...
export class LimitedCollection<Key, Value> extends Collection<Key, Value> {
  ...
  public keepOverLimit:
    | ((value: Value, key: Key, collection: this) => boolean)
    | null;
}
...
export interface MessageChannelCollectorOptionsParams<
  ComponentType extends MessageComponentType,
  Cached extends boolean = boolean
> extends MessageChannelComponentCollectorOptions<
    MappedInteractionTypes<Cached>[ComponentType]
  > {
  componentType?: ComponentType;
}
...
export type WrapBooleanCache<Cached extends boolean> = If<
  Cached,
  "cached",
  CacheType
>;
...
> extends ContextMenuCommandInteraction<Cached> {
  ...
  public options: Omit<
    ...
    | "getSubcommand"
  >;
  public get targetMessage(): NonNullable<
    CommandInteractionOption<Cached>["message"]
  >;
  public inGuild(): this is MessageContextMenuCommandInteraction<
    "raw" | "cached"
  >;
...
export class ModalSubmitFields {
  private constructor(
    components: readonly (readonly ModalActionRowComponent[])[]
  );
...
export abstract class ThreadOnlyChannel extends GuildChannel {
  ...
  public setAvailableTags(
    tags: readonly GuildForumTagData[],
    reason?: string
  ): Promise<this>;
...
> {
  ...
  public on(
    event: "end",
    listener: (
      collected: ReadonlyCollection<Snowflake, MessageReaction>,
      reason: string
    ) => void
  ): this;
  public on(event: string, listener: (...args: any[]) => void): this;
...
export class SKUFlagsBitField extends BitField<SKUFlagsString> {
  ...
  public static resolve(
    bit?: BitFieldResolvable<SKUFlagsString, number>
  ): number;
}
...
export class Sweepers {
  ...
  public sweepEntitlements(
    filter: CollectionSweepFilter<
      SweeperDefinitions["entitlements"][0],
...
export type TextThreadChannel =
  | PublicThreadChannel<false>
  | PrivateThreadChannel;
export type AnyThreadChannel = TextThreadChannel | ForumThreadChannel;

export interface PublicThreadChannel<Forum extends boolean = boolean>
  extends ThreadChannel<Forum> {
...
> extends BaseChannel {
  ...
  public setAppliedTags(
    ...
    reason?: string
  ): Promise<If<ThreadOnly, this, never>>;
...
> extends Base {
  ...
  public get guildMember(): HasMemberData extends true
    ? GuildMember
    : GuildMember | null;
  public id: Snowflake;
  public get joinedAt(): Date | null;
...
export function discordSort<
  Key,
  Value extends { rawPosition: number; id: Snowflake }
>(collection: ReadonlyCollection<Key, Value>): Collection<Key, Value>;
export function cleanCodeBlockContent(text: string): string;
export function fetchRecommendedShardCount(
  token: string,
...
export function resolvePartialEmoji(
  emoji: Emoji | EmojiIdentifierResolvable
): PartialEmoji | null;
...
export function parseWebhookURL(
  url: string
): WebhookClientDataIdWithToken | null;
/** @internal */
...
// tslint:disable-next-line no-empty-interface
export interface Webhook<Type extends WebhookType = WebhookType>
  extends WebhookFields {}
export class Webhook<Type extends WebhookType = WebhookType> {
  ...
  public owner: Type extends WebhookType.Incoming
    ? User | APIUser | null
    : User | APIUser;
  public sourceGuild: Type extends WebhookType.ChannelFollower
    ? Guild | APIPartialGuild
    : null;
  public sourceChannel: Type extends WebhookType.ChannelFollower
...
export interface ApplicationCommandRoleOptionData
  extends BaseApplicationCommandOptionsData {
...
export interface ApplicationCommandUserOptionData
  extends BaseApplicationCommandOptionsData {
...
export interface ApplicationCommandMentionableOptionData
  extends BaseApplicationCommandOptionsData {
...
export interface ApplicationCommandNumericOptionData
  extends ApplicationCommandChoicesData<number> {
  type: CommandOptionNumericResolvableType;
  minValue?: number;
  min_value?: number;
  maxValue?: number;
...
export interface ApplicationCommandStringOptionData
  extends ApplicationCommandChoicesData<string> {
  type: ApplicationCommandOptionType.String;
  minLength?: number;
  min_length?: number;
  maxLength?: number;
...
export interface ApplicationCommandBooleanOptionData
  extends BaseApplicationCommandOptionsData {
  type: ApplicationCommandOptionType.Boolean;
}

export interface ApplicationCommandNumericOption
  extends ApplicationCommandChoicesOption<number> {
  type: CommandOptionNumericResolvableType;
  minValue?: number;
  maxValue?: number;
}
...
export interface ApplicationCommandStringOption
  extends ApplicationCommandChoicesOption<string> {
  type: ApplicationCommandOptionType.String;
  minLength?: number;
  maxLength?: number;
}
...
export interface Caches {
  ...
  ApplicationEmojiManager: [
    manager: typeof ApplicationEmojiManager,
    holds: typeof ApplicationEmoji
  ];
  ...
  DMMessageManager: [
    manager: typeof MessageManager,
    holds: typeof Message<false>
  ];
  EntitlementManager: [
    manager: typeof EntitlementManager,
  ...
  GuildTextThreadManager: [
    manager: typeof GuildTextThreadManager,
    holds: typeof ThreadChannel<false>
  ];
...
export type OmitPartialGroupDMChannel<Structure extends { channel: Channel }> =
  Structure & {
...
export type CollectorFilter<Arguments extends unknown[]> = (
  ...args: Arguments
) => Awaitable<boolean>;
...
> {
  ...
  roles?: ReadonlyCollection<
    Snowflake,
    CacheTypeReducer<Cached, Role, APIRole>
  >;
  channels?: ReadonlyCollection<
    Snowflake,
    CacheTypeReducer<Cached, Channel, APIInteractionDataResolvedChannel>
  >;
  messages?: ReadonlyCollection<
    Snowflake,
...
export interface AutocompleteFocusedOption
  extends Pick<CommandInteractionOption, "name"> {
  focused: true;
  type:
    | ApplicationCommandOptionType.String
    | ApplicationCommandOptionType.Integer
...
> {
  ...
  Invite: Invite;
  Message: TActionType extends AuditLogEvent.MessageBulkDelete
    ? Guild | { id: Snowflake }
    : User;
...
export type GuildAuditLogsTargetType =
...
export interface GuildChannelCloneOptions
  extends Omit<GuildChannelCreateOptions, "name"> {
  name?: string;
}
...
export interface GuildStickerCreateOptions {
  file:
    ...
    | Stream
    | AttachmentPayload
    | JSONEncodable<AttachmentBuilder>;
  name: string;
  tags: string;
  description?: string | null;
  reason?: string;
...
export interface GuildOnboardingEditOptions {
  prompts?:
    | readonly GuildOnboardingPromptData[]
    | ReadonlyCollection<Snowflake, GuildOnboardingPrompt>;
  defaultChannels?:
    | readonly ChannelResolvable[]
    | ReadonlyCollection<Snowflake, GuildChannel>;
  enabled?: boolean;
...
export interface GuildOnboardingPromptData {
  ...
  options:
    | readonly GuildOnboardingPromptOptionData[]
    | ReadonlyCollection<Snowflake, GuildOnboardingPromptOption>;
}
...
export interface InteractionDeferReplyOptions {
  ...
  flags?:
    | BitFieldResolvable<
        Extract<MessageFlagsString, "Ephemeral">,
...
export interface InteractionButtonComponentData
  extends BaseButtonComponentData {
...
export interface MessageCollectorOptions
  extends CollectorOptions<[Message, Collection<Snowflake, Message>]> {
  max?: number;
  maxProcessed?: number;
}
...
export type MessageComponent =
  | Component
  | ActionRowBuilder<
      MessageActionRowComponentBuilder | ModalActionRowComponentBuilder
    >
  | ButtonComponent
  | StringSelectMenuComponent
  | UserSelectMenuComponent
...
export type CollectedMessageInteraction<Cached extends CacheType = CacheType> =
  Exclude<CollectedInteraction<Cached>, ModalSubmitInteraction>;
...
export interface StringSelectMenuComponentData
  extends BaseSelectMenuComponentData {
...
export interface PartialGuildMember
  extends Partialize<GuildMember, "joinedAt" | "joinedTimestamp" | "pending"> {}
...
export interface PartialThreadMember
  extends Partialize<ThreadMember, "flags" | "joinedAt" | "joinedTimestamp"> {}
...
export interface MessageReplyOptions
  extends Omit<MessageCreateOptions, "reply" | "forward"> {
  failIfNotExists?: boolean;
}
...
export type CollectionSweepFilter<Key, Value> = (
  value: Value,
  key: Key,
...
export type SendableChannels = Extract<
  Channel,
  { send: (...args: any[]) => any }
>;
...
export type CategoryChildChannel = Exclude<
  Extract<Channel, { parent: CategoryChannel | null }>,
  CategoryChannel
>;
...
export interface GuildTextThreadCreateOptions<AllowedThreadType>
  ...
  invitable?: AllowedThreadType extends ChannelType.PrivateThread
    ? boolean
    : never;
}
...
export interface WebhookClientOptions
  extends Pick<ClientOptions, "allowedMentions" | "rest"> {}
...
export interface ClientApplicationEditOptions {
  ...
  eventWebhooksStatus?:
    | ApplicationWebhookEventStatus.Enabled
    | ApplicationWebhookEventStatus.Disabled;
